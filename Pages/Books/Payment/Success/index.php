      ...
      <div class="alert alert-danger d-flex flex-column align-items-center text-center w-50 m-auto" role="alert">
        ...
        <div class="content w-100">
          ...
          <h4 class="fw-semibold">
            <i class="ri-error-warning-line"></i> Payment error
          </h4>
          <hr>
          <p class="mb-0">
  ...
  <?php else: ?>
    <div class="error-container">
      <div class="lottie-animation">
        <dotlottie-player
          src="https://lottie.host/fcd31833-952e-4d6f-bc53-e174cb8c8d26/JZPxP2p9NB.lottie"
      ...
      <div class="error-content">
        ...
        <a href="../../../../" class="btn btn-outline-primary fw-semibold">
          <i class="ri-home-4-line"></i> Back To Home</a>
      </div>
    </div>
