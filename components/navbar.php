    ...
    <div class="container-fluid mx-4">
        ...
        <?php if (isset($_SESSION["login"])) : ?>
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link fw-semibold text-white" href="#profile">Warca</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-semibold text-white" href="#colletion-books">Collection Books</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link fw-semibold text-white dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                            Setting
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item fw-normal" href="./Pages/My_books/">
